...
struct i2c_algorithm {
	...
	/* i2c recovery */
	int (*i2c_recovery) (struct i2c_adapter *);
...
struct i2c_im_msg {
	struct i2c_msg 	*msgs;	/* Pointer to array of i2c_msg structs */
	int num;				/* Number of i2c_msgs in msgs array */
	int id;
};
...
#define I2C_SLAVEREAD		0x0709  /* Perform slave read */
#define I2C_SLAVEWRITE		0x070a  /* Perform slave write */
#define I2C_SET_HOST_ADDR	0x070b  /* Change slave address of the controller */
#define I2C_GET_HOST_ADDR   0x070c  /* Get current slave addr of controller */
#define I2C_RESET			0x070d  /* Reset the controller */
#define I2C_SMBUS			0x0720  /* SMBus-level access */
#define I2C_CLOCK_OUT_DATA_PIN	0x0721 /* SMBus Data Low Recovery */
#define I2C_GET_REC_INFO		0x0722 /* SMBus Get Recovery Info */
#define I2C_SET_REC_INFO		0x0723 /* SMBus Get Recovery Info */

// joe --- begin
#define I2C_GETREG			0x0730	/* Get I2C register content */
#define I2C_SETREG			0x0731	/* Write I2C register content */
// joe --- end
typedef struct  {
	int num_pulses;
	int period;
