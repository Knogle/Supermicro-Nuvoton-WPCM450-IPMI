...
***************************************************************************/
 ...
 #endif
#elif
  #error "Non Windows or Linux compilation in platform detection!!"
#endif
...
#if !defined(ICC_PLATFORM_X86) && !defined(ICC_PLATFORM_PPC) && !defined(ICC_PLATFORM_ARM)&& !defined(ICC_PLATFORM_MIPS)
    #error "Neither PPC nor X86 nor ARM nor MIPS is defined"
#endif
