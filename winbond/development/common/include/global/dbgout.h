...
#else
#define PLATFORM_DBGLOGFN(n,fmt,args...)  
#define PLATFORM_DBGLOGBUFFN(n,TDBG_FILENAME,TDBG_LINENO,BUF,LEN)
#endif
...
#if defined (ICC_OS_LINUX) /*linux takes variable arg macros*/
...
#define     TAUDIT(x)              
#else
#define     TAUDIT(ModuleName,fmt,args...)              PLATFORM_AUDITOUTFN(LOG_NOTICE,ModuleName " " fmt,##args)
#endif
