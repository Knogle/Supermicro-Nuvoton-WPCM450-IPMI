...
#define UBOOT_ENV_START_OFFSET			(CFG_PROJ_UBOOT_ENV_START - CFG_PROJ_FLASH_START)
...
int PrepareImageFlashArea();
extern int PrepareImageFlashArea_USB(void);
extern int PrepareImageYafuFlashArea();
