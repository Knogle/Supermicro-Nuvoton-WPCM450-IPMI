...
#define MAX_ERASE_BLOCK_SIZE CFG_PROJ_ERASE_BLOCK_SIZE
...
#define ERASE_BLOCK_SIZE	CFG_PROJ_ERASE_BLOCK_SIZE

#define FLASH_IMAGE_SIZE	CFG_PROJ_USED_FLASH_IMAGE_SIZE
