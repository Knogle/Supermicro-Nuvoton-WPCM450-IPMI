 ...
 *-------------------------------------------------------------------*/
extern int API_ReadNVR (char *NVRName, INT16U Offset, INT16U Size, _FAR_ INT8U* pBuf);
 ...
 *-------------------------------------------------------------------*/
extern int API_WriteNVR (char *NVRName, INT16U Offset, INT16U Size, INT8U* pBuf);
