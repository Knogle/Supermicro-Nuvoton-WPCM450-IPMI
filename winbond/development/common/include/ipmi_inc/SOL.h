...
/*------------------ Extern Definitions --------------------------*/
extern void     WakeupSOLTask (void);
extern INT32U   tick_diff (INT32U t1, INT32U t2);
extern int      SOLTask (void);
extern int	OpenSOLPort (void);
extern int	CloseSOLPort (void);
extern int	ConfigureSOLPort (void);
extern void     AssertSOLCTS  (void);
extern void     DeAssertSOLCTS(void);
extern INT32U  g_cur_tick;
extern INT8U   g_sol_retry;
extern int	   g_sol_fd;
extern volatile int     g_cts;
