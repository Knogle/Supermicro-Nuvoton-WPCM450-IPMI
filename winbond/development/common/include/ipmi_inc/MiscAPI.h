 ...
 *---------------------------------------------------------------*/
extern INT8U API_GenerateBeep (INT16U Pattern, INT8U NumSec);
 ...
 *---------------------------------------------------------------*/
extern INT8U API_GlowLED (INT8U LEDNum, INT16U Pattern, INT16U NumSec);
 ...
 *---------------------------------------------------------------*/
extern BOOL API_GetLEDEnabled (INT8U LEDNum);
 ...
 * @return LED Pattern
 *---------------------------------------------------------------*/
extern INT16U API_GetLEDPattern (INT8U LEDNum);
 ...
 *
 *---------------------------------------------------------------*/
extern BMCSharedMem_T* API_GetBMCSharedMem (void);
 ...
 *---------------------------------------------------------------*/
extern int API_FlushPMConfig (INT8U* pNVRPtr, INT16U Size);
 ...
 *
 *---------------------------------------------------------------*/
extern PMConfig_T* API_GetPMConfig (void);

/*----------------------------------------------------------------
 * API_ChassisIdentify
*---------------------------------------------------------------*/
extern int API_ChassisIdentify (INT8U Timeout);
