...
#ifdef MAX_LAN_CHANNELS
#define NUM_LAN_DESTINATION                 MAX_LAN_CHANNELS*LAN_DESTINATIONS_PER_CHANNEL
#define MAX_ALERT_POLICY_ENTRIES            MAX_LAN_CHANNELS*(ALERT_POLICY_PER_CHANNEL * 4)
#else
