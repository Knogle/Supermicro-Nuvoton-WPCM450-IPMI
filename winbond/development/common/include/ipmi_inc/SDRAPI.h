 ...
 *-----------------------------------------------------------------*/
extern int API_GetSDRRepositoryInfo (SDRRepositoryInfo_T* pRepositoryInfo);
 ...
 *			-1	if no repository, or repository bad.
 *-----------------------------------------------------------------*/
extern int API_GetSDRAllocInfo (SDRRepositoryAllocInfo_T* pAllocInfo);
 ...
 *-----------------------------------------------------------------*/
extern INT16U API_GetFirstSDR (_FAR_ INT8U* pSDRRecord);
 ...
 *                     -1       if error
 *-----------------------------------------------------------------*/
extern int API_GetNextSDR (INT16U* pRecordID, _FAR_ INT8U* pSDRRecord);
 ...
 *-----------------------------------------------------------------*/
extern SDRRecHdr_T* API_GetSensorSDR (INT8U SensorNum);
 ...
 *			0	if failed.
 *-----------------------------------------------------------------*/
extern INT16U API_AddSDRRecord (_FAR_ INT8U* pSDRRecord, INT8U RecordLen);

/*-----------------------------------------------------------------
 * @fn API_DelSDRRecord [Farida] added
 * @brief Delete an  SDR Record.
 * @param pSDRRecord	- Pointer to the buffer holding the SDR Record.
 * @param RecordLen     - SDR Record length.
 * @return 	Record ID of the record added.
 *			0	if failed.
 *-----------------------------------------------------------------*/
extern INT16U API_DelSDRRecord (DeleteSDRReq_T* pReqDeleteSDR);
 ...
 *			-1	if failed.
 *-----------------------------------------------------------------*/
extern int API_ClearSDRRepository (void);
 ...
 *			-1	if failed.
 *-----------------------------------------------------------------*/
extern int API_GetSensorThresholds (INT8U SensorNum, GetSensorThresholdRes_T* SensorThresh);
 ...
 *			-1	if failed.
 *-----------------------------------------------------------------*/
extern int API_SetSensorThresholds (INT8U SensorNum, SetSensorThresholdReq_T* SensorThresh);
 ...
 *			-1	if failed.
 *-----------------------------------------------------------------*/
extern int API_GetSensorReading (INT8U SensorNum, GetSensorReadingRes_T* SensorRead);
 ...
 *			0xFF	if failed.
 *-----------------------------------------------------------------*/
extern INT8U API_GetSensorNum (const char * SensorName);
 ...
 *			NULL	if failed.
 *-----------------------------------------------------------------*/
extern const char* API_GetSensorName (INT8U SensorNum);
