 ...
 *			-1 if error.
 *------------------------------------------------------------------*/
extern INT16U API_GetFRUDeviceSize (INT8U DeviceID);
 ...
 *			-1 if error.
 *------------------------------------------------------------------*/
extern INT16U API_ReadFRUDevice (INT8U DeviceID, INT16U Offset, INT16U Len, _FAR_ INT8U* pBuf);
 ...
 *			-1 if error.
 *------------------------------------------------------------------*/
extern INT16U API_WriteFRUDevice (INT8U DeviceID, INT16U Offset, INT16U Len, _FAR_ INT8U* pBuf);
