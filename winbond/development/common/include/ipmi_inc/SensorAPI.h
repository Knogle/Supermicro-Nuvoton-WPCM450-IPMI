 ...
 *		-1	if reinit failed.
 *-----------------------------------------------------------------*/
extern int API_ReInitSensor (INT8U u8SensorNum);
 ...
 *		-1	if set failed.
 *-----------------------------------------------------------------*/
extern int API_SetSensorScanning (INT8U u8SensorNum, INT8U EnableFlag);
/*-----------------------------------------------------------------
 * @fn API_SetScanningInterval
...
extern int API_SetSensorInternalScanning (INT8U u8SensorNum, INT8U EnableFlag);
 ...
 *		-1	if set failed.
 *-----------------------------------------------------------------*/
extern int API_SetSensorState (INT8U u8SensorNum, INT8U State);
 ...
 *		-1	if set failed.
 *-----------------------------------------------------------------*/
extern SensorInfo_T* API_GetSensorInfo (INT8U SensorNum);
 ...
 *		-1	if failed.
 *-----------------------------------------------------------------*/
extern int  API_GlobalSensorScanningEnable (BOOL bEnable);
 ...
 *
 *-----------------------------------------------------------------*/
extern int  API_GetGlobalSensorScanningEnable ();
 ...
 *		-1	if failed.
 *-----------------------------------------------------------------*/
extern int API_RegSensorCB (INT8U SensorNum, void *pCB, HookType_e HookType);
//<sakthi>Added to Support SensorAveraging.../
void API_SensorAverage(INT8U SensorNum, INT16U* SensorReading);
...
//<<KAMAL>>Added to Support Rearming sensors from PDK hooks ./
extern int API_ReArmSensor (ReArmSensorRes_T* pReArmSensorRes);
 ...
 *
 *-----------------------------------------------------------------*/
extern int API_SetSensorReadingOffset ( INT8U SensorLUN ,  INT8U SensorNo ,  INT8S Offset );
...
extern int API_GetSensorReadingOffset ( INT8U SensorLUN ,  INT8U SensorNo ,  INT8S * pOffset );
