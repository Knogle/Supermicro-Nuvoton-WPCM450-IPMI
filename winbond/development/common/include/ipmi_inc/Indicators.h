...
**/
extern INT8U GlowLED (INT8U LEDNum, INT16U Pattern, INT16U NumSec);

/**
 * @brief Return Enable flag for particular LED
 * @param LEDNum   - LED number to lookup.
**/
extern BOOL GetLEDEnabled (INT8U LEDNum);

/**
 * @brief Return blink pattern for particular LED
 * @param LEDNum   - LED number to lookup.
**/
extern INT16U GetLEDPattern (INT8U LEDNum);
...
**/
extern INT8U GenerateBeep (INT16U Pattern, INT16U NumSec);

/**
 * @brief Monitors LED & Beep in a specified pattern for N sec.
**/
extern void	MoniterIndicators (void);
