...
extern int CheckCmdCfg (_FAR_ CmdHndlrMap_T* pCmdHndlrMap, 
                        INT8U ChannelNum, INT8U NetFn, INT8U Cmd);
...
**/
extern _FAR_ INT8U* GetCmdCfgAddr (INT8U NetFn, INT8U Cmd);
...
extern int GetSubFnMask (INT8U ChannelNum, INT8U NetFn, 
                         INT8U Cmd, _NEAR_ INT32U* pSubFnMask);
...
**/
extern int GetCmdSupCfgMask (INT8U NetFn, INT8U Cmd, _NEAR_ INT16U* pFFConfig);
