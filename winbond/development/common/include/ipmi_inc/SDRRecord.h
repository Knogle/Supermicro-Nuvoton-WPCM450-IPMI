...
#define SDR_REC_START(pSDR) ((_FAR_ INT8U*)(((_FAR_ SDRRepository_T*) pSDR)->FreeBytes))
#define SDR_REC_END(pSDR)   ((_FAR_ INT8U*)(&(((_FAR_ SDRRepository_T*) pSDR)->FreeBytes [NUM_FREE_BYTES])))
...
#define SDR_NUM_FREE_BYTES      (MAX_SDR_SIZE - SDR_REPOSITORY_HEADER)
