...
int  hmac_sha1_key ( INT8U* pkey, INT32U key_len,  Hmac_Ctx_T* pcx);
void hmac_sha1_data ( INT8U* pdata, INT32U data_len,  Hmac_Ctx_T* pcx);
void hmac_sha1_end ( INT8U* pmac, INT32U mac_len,  Hmac_Ctx_T* pcx);
